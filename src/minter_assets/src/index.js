...
const plugLogin = document.getElementById("plugLogin");
const plugLogout = document.getElementById("plugLogout");
...
(async () => {
  ...
  if (connected) {
    ...
    plugLogin.style.display = 'none';
  } else {
    plugLogout.style.display = 'none';
  }
})()


plugLogin.addEventListener("click", () => {
  (async () => {
